...
public class zaxisPlanes extends planeExtraction {

  public void execute() {
    Simulation simulation_0 = 
      getActiveSimulation();
    
for(int i=1; i<zLoop; i++)
{ 
// setup
    Units units_0 = 
...
// set the axis coordinates
        ...
        coordinate_4.setValue(new DoubleVector(new double[] {0.0, 0.0, z}));

        coordinate_4.setCoordinate(units_0, units_0, units_0, new DoubleVector(new double[] {0.0, 0.0, z}));
...
// set the axis orientation
        ...
        coordinate_5.setValue(new DoubleVector(new double[] {0.0, 0.0, 1.0}));

        coordinate_5.setCoordinate(units_0, units_0, units_0, new DoubleVector(new double[] {0.0, 0.0, 1.0}));
