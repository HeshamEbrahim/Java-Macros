...
public class xaxisPlanes extends planeExtraction {
...
// set the axis coordinates
        ...
        coordinate_4.setValue(new DoubleVector(new double[] {x, 0.0, 0.0}));

        coordinate_4.setCoordinate(units_0, units_0, units_0, new DoubleVector(new double[] {x, 0.0, 0.0}));
...
// set the axis orientation
        ...
        coordinate_5.setValue(new DoubleVector(new double[] {1.0, 0.0, 0.0}));
